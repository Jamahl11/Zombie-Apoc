...
extern int cheat;
# 29 "main.c" 2
# 1 "playerSpriteSheet.h" 1
# 21 "playerSpriteSheet.h"
...
# 1 "pause.h" 1
# 22 "pause.h"
extern const unsigned short pauseTiles[2960];
...
# 35 "main.c" 2
# 1 "FinalProjectTopMap.h" 1
# 22 "FinalProjectTopMap.h"
extern const unsigned short FinalProjectTopMapTiles[9456];


extern const unsigned short FinalProjectTopMapMap[2048];


extern const unsigned short FinalProjectTopMapPal[256];
# 36 "main.c" 2
# 1 "gameMap.h" 1
# 22 "gameMap.h"
...
void goToStart() {
    ...
    DMANow(3, startTiles, &((charblock *)0x6000000)[0], 19168 / 2 );
...
void goToInstruct() {
    ...
    DMANow(3, instructionsTiles, &((charblock *)0x6000000)[0], 4832 / 2 );
...
void goToGame() {
    ...
    (*(volatile unsigned short *)0x4000008) = (0 << 7) | (3 << 14) | ((0) << 2) | ((27) << 8);
    (*(volatile unsigned short *)0x400000A) = (0 << 7) | (3 << 14) | ((2) << 2) | ((23) << 8);
    ...
    DMANow(3, bottomBgPal, ((unsigned short *)0x5000000), 512 / 2);

    DMANow(3, topBgTiles, &((charblock *)0x6000000)[0], 29376 / 2 );
    DMANow(3, topBgMap, &((screenblock *)0x6000000)[27], 8192 / 2);

    DMANow(3, bottomBgTiles, &((charblock *)0x6000000)[2], 4928 / 2 );
    DMANow(3, bottomBgMap, &((screenblock *)0x6000000)[23], 8192 / 2);


    DMANow(3, playerSpriteSheetPal, ((unsigned short *)0x5000200), 512 / 2);
    DMANow(3, playerSpriteSheetTiles, &((charblock *)0x6000000)[4], 32768 / 2);
...
void goToPause() {
    ...
    DMANow(3, pauseTiles, &((charblock *)0x6000000)[0], 5920 / 2 );
...
void goToLose() {
    ...
    DMANow(3, loseTiles, &((charblock *)0x6000000)[0], 17472 / 2 );
